  ...
  return (
    <div className="flex flex-col gap-8 pb-40 px-4 sm:px-6 w-full max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-start w-full">
        ...
        {/* COLUMN 1: Vitals checklists & WhatsApp setups */}
        ...
        <div className="flex flex-col gap-6">
          {/* Nearby Support */}
          <Card className="p-5 border-slate-100 rounded-[2rem] bg-white border shadow-sm flex flex-col gap-3">
            <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Nearby Support Clinics</h4>
            
            <div className="p-4 border-slate-100 rounded-[1.75rem] flex items-center justify-between shadow-xs hover:shadow-md transition-all border cursor-pointer bg-white" onClick={onClinicSearch}>
               <div className="flex items-center gap-3">
